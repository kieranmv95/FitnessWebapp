...
const Reps = ({
  ...
  <div
    key={setIndex}
    className="grid grid-cols-[2.125rem_1fr_2.125rem] gap-1 mb-1"
  >
    <p className="text-zinc-600 py-1 px-2 md:py-2 md:px-3 rounded inline-block font-bold bg-white text-center">
      {setIndex + 1}
    </p>
    <Field
      type="number"
